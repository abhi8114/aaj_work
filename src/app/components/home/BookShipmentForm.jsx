...
const BookShipmentForm = () => {
  ...
  <form>
    ...
    <div className="px-[5%] md:px-11 pb-12">
      <button
        type="submit"
        className="w-full bg-themeRed text-white py-2 rounded-md hover:bg-red-700 transition duration-300"
      >
        Book Shipment
      </button>
    </div>
